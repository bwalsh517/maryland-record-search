...
(function (global) {
    ...
    class SM35Series extends BaseSeries {
        ...
        constructor() {
            ...
            // NEW, standardized shape for SM35-1 through 72 - the only
            // records with a real scan, and therefore the only ones
            // worth this transcription work so far. dateRanges' split
            // (per entry, since coverage genuinely varies month to
            // month within one record) replaces the free-text
            // `description` for search purposes; note keeps the
            // original MSA guide text verbatim for display, unparsed,
            // same as the description field above.
            //
            ...
            // independently re-checked: every one of the 108 distinct
            // year/month combinations across these 72 records was
            // confirmed to cover the full 23 counties once every
            // record touching that month is combined - no county
            // silently missing from any month.
            //
